...
public class PosterWall {
    ...
    static ItemFrame[] getMatchingMapFrames(PosterMap map, FlatLocation location, short mapId) {
    ...
    private static ItemFrame[] getMatchingMapFrames(PosterMap map, FlatLocation location) {
    ...
    private static ItemFrame getMapFrameAt(FlatLocation location, PosterMap map) {
    ...
    private static ItemFrame getEmptyFrameAt(Location location, BlockFace facing) {
        Entity entities[] = location.getChunk().getEntities();
